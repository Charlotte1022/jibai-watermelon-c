...
const maxRandomFruitNum = 7; // 生成随机水果最大值（1-11）
let setFruits = {
...
let adLink = 'https://weibo.com/2785629971/EoyVA63th';

// 修改网页标题：将 "合成大西瓜" 进行替换
document.getElementsByTagName("title")[0].innerText = '合成永远的神季白！西南以南季白最白！';
